...
export default function Updatefee() {
  ...
  const [CardType, setCardType] = useState(  localStorage.getItem("CardType"));
  const [Amount, setAmount] = useState(  localStorage.getItem("Amount"));
  const [paymentTitle, setpaymentTitle] = useState(  localStorage.getItem("paymentTitle"));
  ...
  function formSubmitHandler(e) {
    ...
    axios
      .put(`http://localhost:8089/payments/updatepayment/${paymentid}`, newAssignment)
      .then(() => {
          ...
          <div className="container">
            ...
            >
              <div className="modal-body">
                <h1 className="text-center">Update fee</h1>
                <br />
